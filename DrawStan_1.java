...
public class DrawStan_1 {
    ...
    private static final float HEIGHT_BODY=1.2f;
    ...
    public void draw_stan (GL gl, boolean walk, boolean jump,boolean a, boolean s, boolean d, boolean f, boolean e,boolean o){
       ...
       //stan is jumping
        ...
        else if (f && mvt%20+10>20 ){
            //gl.glRotatef(95f, 0f, 0f, 1f);
            draw_legs(gl, glu, ' ', false);
            draw_legs(gl, glu, ' ', true);
            
            gl.glTranslatef(-.2f, 0f, 0f);
            gl.glRotatef(55f, 0f, 0f, 1f);
            draw_arm_left(gl, glu, 'J');
            draw_arm_right(gl, glu, ' ');
            draw_head (gl, glu,' ',' ');
    ...
    public void draw_body (GL gl, GLU glu){
        ...
        set_red_material(gl);
        gl.glPushMatrix();       
        gl.glTranslatef(0.0f, HEIGHT_BODY-.4f, 0f);
    ...
    public void draw_head (GL gl, GLU glu,char a,char b){
        ...
        gl.glTranslatef(-.08f, 0.4f, 0.205f);        
        glu.gluSphere(q, WIDTH_EYES, SLICES, STACKS);
        gl.glTranslatef(0.16f, 0.0f, 0.0f);        
        glu.gluSphere(q, WIDTH_EYES, SLICES, STACKS);
        ...
        if (b == 'A'){
            ...
            gl.glTranslatef(0f, 0.19f, 0.32f);        
            glu.gluSphere(q, WIDTH_OPEN_MOUTH, SLICES, STACKS);
        }
        if (b == 'S'){
            set_grey_material(gl);
            gl.glTranslatef(0f, 0.19f, 0.32f);        
            glu.gluSphere(q, WIDTH_OPEN_MOUTH+.1, SLICES, STACKS);
        }
        if (b == 'J'){
            set_grey_material(gl);
            gl.glTranslatef(0f, 0.19f, 0.32f);        
            glu.gluSphere(q, WIDTH_OPEN_MOUTH+.05, SLICES, STACKS);
        }
        if (b == ' '){
            gl.glTranslatef(0.1f, 0.19f, 0.32f);   
     ...
     public void draw_hat (GL gl, GLU glu){
        ...
        set_grey_material(gl);
        gl.glPushMatrix();       
        gl.glTranslatef(0.0f, HEIGHT_BODY-1, 0f);
        gl.glRotatef(90f, 1f, 0f, 0f);
        glu.gluCylinder(q, .07, .07, -2f, SLICES, STACKS);
         //we create stan body
        set_red_material(gl);
        
        gl.glRotatef(90f, -1f, 0f, 0f);
        gl.glTranslatef(0.0f, HEIGHT_BODY-.6f, 0f);
        gl.glRotatef(90f, 1f, 0f, 0f);
        glu.gluDisk(q, 0f, BOTTOM_BODY, SLICES, STACKS);
        ...
        gl.glPopMatrix();
          ...
          set_grey_material(gl);
        gl.glPushMatrix();
        gl.glTranslatef(0.0f, HEIGHT_BODY+1f, 0f);
        gl.glRotatef(90f, -1f, 0f, 0f);

        glu.gluCylinder(q, .07, 0, 0.1f, SLICES, STACKS);
     ...
     public void draw_legs(GL gl, GLU glu, char c, boolean left){
        ...
        if (c == 'D'){
         gl.glTranslatef(0f, -0.5f, -0.15f);
            if (left)
                        gl.glRotatef(90f, -1f, 0f, 0f);

                //gl.glRotatef(110, -90f, -145f, 0f); 
            else
                        gl.glRotatef(90f, -1f, 0f, 0f);

                //gl.glRotatef(45, -180f, 145f, 0f); 
     }
     ...
     public void draw_arm_left (GL gl, GLU glu, char c){
        ...
        if (c=='S'){  
            gl.glTranslatef(-0.45f, -0.30f, -0.2f);  
            glu.gluSphere(q, WIDTH_HANDS, SLICES, STACKS);
            gl.glTranslatef(0.05f, 0.015f, 0.05f);   
            glu.gluSphere(q, WIDTH_FINGERS, SLICES, STACKS);
        }
     ...
     public void draw_arm_right (GL gl, GLU glu, char c){
        ...
        if (c=='S'){  
            gl.glTranslatef(0.45f, -0.3f, -.18f);  
            glu.gluSphere(q, WIDTH_HANDS, SLICES, STACKS);
            gl.glTranslatef(-0.05f, 0.015f, 0.05f);   
            glu.gluSphere(q, WIDTH_FINGERS, SLICES, STACKS);
        }
    ...
    public void set_grey_material (GL gl){
        ...
        float mat_ambient[]={0.06f,0.06f,0.06f,0.0f};
        float mat_diffuse[]={1.0f,1.0f,1.0f,1.0f};
        float mat_specular[]={0.8f,0.8f,0.8f,1.0f};
        float shine=125.2f;    
